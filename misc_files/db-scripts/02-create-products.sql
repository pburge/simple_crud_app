...
-- Schema crud-app
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `crud-app`;

CREATE SCHEMA `crud-app`;
USE `crud-app` ;

-- -----------------------------------------------------
-- Table `crud-app`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-app`.`product_category` (
...
-- -----------------------------------------------------
-- Table `crud-app`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `crud-app`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
